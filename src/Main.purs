...
jump true p@{ y = 0 } = p { vy = -20, css = "jumping", sound = Sound "sfx/jump.ogg" 1 }
jump _ p = p
...
hated hater p _ | intersects hater p =
  velocity $ p { css = "gameover", vy = -15, sound = ExclusiveSound "sfx/gameover.ogg" 1 }
...
coinLogic _ c | c.vy < 0 =
  clearSound $ velocity $ reset initialCoin c { vy = c.vy * 2}
coinLogic pinkie c | intersects pinkie c =
  c { vx = 0, vy = -1, sound = Sound "sfx/coin.ogg" 1 }
coinLogic pinkie c =
